      ...
      >
        <div className="glass-strong rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-1">Create your account and transform your health</p>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 mt-6 pt-6 border-t border-white/5">
            ...
            <span className="text-xs text-muted-foreground">Begin your AI-powered health journey</span>
          </div>
        </div>
      </motion.div>
    </div>
